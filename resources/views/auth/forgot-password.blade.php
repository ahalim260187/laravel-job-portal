                ...
                <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
                    <div class="login-register-cover">
                        <div class="text-center">
                            <h2 class="mt-10 mb-10 text-brand-1">Forgot Password!</h2>
                            @if (!session('status'))
                                <p class="font-sm text-muted mb-30 alert alert-warning">Forgot your password? No problem.
                                    Just
                                    let us know your
                        ...
                        <form class="login-register text-start mt-20" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form-group">
                                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="input-1"
                                    type="text" required name="email" placeholder="stevenjob@gmail.com">
